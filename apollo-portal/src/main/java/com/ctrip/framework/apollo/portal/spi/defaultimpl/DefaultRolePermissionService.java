 ...
 * 实现 RolePermissionService 接口
 * 默认 RolePermissionService 实现类
 */
public class DefaultRolePermissionService implements RolePermissionService {
    ...
    /**
     * 通过 PortalConfig 的 "superAdmin" 配置项，判断是否存在该账号
     * @param userId
     * @return
     */
